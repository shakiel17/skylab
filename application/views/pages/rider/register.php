                ...
                <h1 style="color:white;">Skylab Booking System</h1>
                    ...
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            <?=form_open(base_url()."save_rider_account");?>
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Plate No." name="plateno" type="text" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                        Already a member? <a href="<?=base_url();?>rider">Login</a>
                                        </label>
                                    </div>
